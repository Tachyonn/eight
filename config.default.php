...
//Для тех, кому не нужна разбивка по компаниям, у кого не заполнено поле Company в AD.
$NO_COMPANY_ATTR=true; //Если параметр равен "true", то фильтрация по компании не производится, выводятся все пользователи.
//----------------------------------------------------------------------------
